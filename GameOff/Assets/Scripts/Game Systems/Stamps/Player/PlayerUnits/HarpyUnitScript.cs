...
#region Ability Functions
    ...
    public string GetTileDescription()
    {
        ...
        string stats = Vocab.SEPARATE(new string[] {Vocab.PUSH_DISTANCE(PushDistance), Vocab.SLOW_INTENSITY(_harpySlowIntensity), Vocab.DAMAGE(Damage), Vocab.ATKSPD(_harpyAttackSpeed)});
        return name + "\n" + description + "\n" + stats;
    }
}
